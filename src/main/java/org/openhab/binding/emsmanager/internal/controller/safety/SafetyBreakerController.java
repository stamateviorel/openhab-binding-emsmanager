...
public final class SafetyBreakerController implements Controller {
     ...
     * plugged.
     */
    public static int minHeadroomA(EnergyContext ctx) {
        int min = CapabilityCheck.MAX_CHARGING_CURRENT_A;
        ...
        return anyPlugged ? min : CapabilityCheck.MAX_CHARGING_CURRENT_A;
    }
}
