...
This bundle lives in the canonical dir `org.openhab.binding.emsmanager`; its
directory name and artifactId match, and it is already registered in
`bundles/pom.xml` (between `emotiva` and `energenie`).
